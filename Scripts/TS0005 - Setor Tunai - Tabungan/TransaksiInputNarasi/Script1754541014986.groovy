...
TestObject inputNarasi = new TestObject("inputNarasi")
inputNarasi.addProperty("xpath", ConditionType.EQUALS, "//textarea[@id='xui.UI.Input-INPUT:k:']")
WebUI.click(inputNarasi)
